...
model_def = caffe_root + 'models/4C_new/deploy.prototxt'
model_weights = caffe_root + 'models/4C_new/snapshot/VGG_VOC0712_SSD_750x500_iter_300000.caffemodel'
...
test_dir = '/home/sxl/caffe-ssd/examples/4c/test_img2/' 
test_list = os.listdir(test_dir)
#print test_list
savepath = '/home/sxl/caffe-ssd/examples/4c/test_img3/'
