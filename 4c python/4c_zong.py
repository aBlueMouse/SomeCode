...
test_dir = '/home/sxl/caffe-ssd/models/4C_dingweihuan/test_zong/' 
test_list = os.listdir(test_dir)
#print test_list
savepath = '/home/sxl/caffe-ssd/models/4C_dingweihuan/test_zong_caijian/'
...
# In[45]:
    ...
    for i in xrange(top_conf.shape[0]):
        ...
        if label_name == 'dingweihuan':
            ...
            cropedimg.save(savepath + '/' + "%06d"%j + '.jpg')
            j += 1

    #plt.show()

################################################################################################
labelmap_file = 'data/VOC0712_dingweihuan/labelmap_voc.prototxt'
file = open(labelmap_file, 'r')
labelmap = caffe_pb2.LabelMap()
text_format.Merge(str(file.read()), labelmap)
...
model_def = 'models/4C_dingweihuan/SSD_300x300/deploy.prototxt'
model_weights = 'models/4C_dingweihuan/SSD_300x300/VGG_VOC0712_SSD_300x300_iter_135000.caffemodel'
...
test_dir = '/home/sxl/caffe-ssd/models/4C_dingweihuan/test_zong_caijian/' 
test_list = os.listdir(test_dir)
print test_list
for img in test_list:
    image = caffe.io.load_image(test_dir + img)
