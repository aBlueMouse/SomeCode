...
model_def = caffe_root + 'models/4C_dingweihuan/SSD_300x300/deploy.prototxt'
model_weights = caffe_root + 'models/4C_dingweihuan/SSD_300x300/VGG_VOC0712_SSD_300x300_iter_135000.caffemodel'
...
test_dir = '/media/sxl/石家庄供电段检测车间1/10/1004test/' 
test_list = os.listdir(test_dir)
#print test_list
savepath = '/media/sxl/石家庄供电段检测车间1/10/1008shaixuan3/'
...
# Get detections with confidence higher than 0.6.
    ...
    #print np.mean(top_label_indices)
    ...
    if np.mean(top_label_indices) == 1.0:
        if np.min(top_conf) >= 0.7:
            img_mid.save(savepath + '/' + img)
