...
def Preprocessing(d, stage='train', scale=1):
    ...
    crop_width = (bbox[2] - bbox[0] + 1) * (1 + cfg.imgExtXBorder * 2)
    crop_height = (bbox[3] - bbox[1] + 1) * (1 + cfg.imgExtYBorder * 2)
    ...
    img = cv2.resize(bimg[min_y:max_y+1, min_x:max_x+1, :], (width, height))
