...
class Config:
    ...
    epoch_size = 11314  # include flip * 2, aug * 4, batch * 16#############################################################
    optimizer = 'adam'

    batch_size = 6  # batch size in per gpu i.e. the first dim of inputs
    weight_decay = 1e-5
    ...
    def set_args(self, gpu_ids, continue_train=False, cloth_type):
    ...
    symmetry = [(0, 1), (3, 4), (5, 6), (7, 8), (9, 11), (10, 12), (13, 14)]#######################################
