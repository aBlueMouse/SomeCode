    ...
    while img_start < det_range[1]:
        ...
        for test_id in range(0, len(test_data), batch_size):
            ...
            for test_image_id in range(start_id, end_id):
                ...
                for w in range(cfg.nr_skeleton):
                    cls_skeleton[test_image_id, w, 0] /= details[test_image_id - start_id][0]
                    cls_skeleton[test_image_id, w, 1] /= details[test_image_id - start_id][1]
...
def test(test_model, logger):
    ...
    test_ann_path = '/home/lanhao/FashionAI/test3/test_dress.csv'
    ...
    for i in range(len(anns)):
        ...
        results.append(row)
    write_csv('result_dress_0501.csv', results)
