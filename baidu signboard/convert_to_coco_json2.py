...
XML_PATH = "C:\\Users\\lanhao\\Desktop\\ngdtx\\fusai\\datasets\\Annotations"
...
for xml in xml_names:
    ...
    if len(object_nodes) == 0:
        ...
        image["id"] = int(''.join(re.findall("\d+", file_name)))
       ...
       # print ymax_nodes
        for index, node in enumerate(object_nodes):
            ...
            annotation["image_id"] = int(''.join(re.findall("\d+", file_name)))
